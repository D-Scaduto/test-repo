...
//     tmp = tmp + "</button>";
     ...
     tmp = tmp + "<span id='logo_spot' class='logo' style='display:inline-block;'  >";
     tmp = tmp + "</span>";
...
//     tmp = tmp + "</button>"; 
     ...
     tmp = tmp + "<div id='share_spot' class='inner_menu' style=''  >";
     tmp = tmp + "</div>";
     tmp = tmp + "<div style='clear:both;' ></div>";
     ...
     if (this.shape == "" ) {
	 tmp = tmp + "<div id='rail_spot' class='inner_menu' style='min-width:200px' >";
         tmp = tmp + "</div>";
     }
